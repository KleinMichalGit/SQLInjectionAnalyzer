namespace Model
{
    ...
    public enum ScopeOfAnalysis
    {
        ...
        /// <summary>
        /// Compiles *.csproj files, without performing interprocedural analysis. Uses the same rules as
        /// OneMethodSyntaxTree, therefore provides the same results. This <see cref="ScopeOfAnalysis"/>
        ...
        /// <summary>
        /// Opens all C# solution (*.sln) files, performs n-level interprocedural analysis (where number n is
